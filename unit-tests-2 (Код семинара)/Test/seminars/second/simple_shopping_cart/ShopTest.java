...
*/
    ...
    void priceCartProductsSameTypeIsCorrectCalculated() {
        ...
        cart.addProductToCartByID(3); // 200 +
        cart.addProductToCartByID(3); // 200 = 600

        assertThat(cart.getTotalPrice()).isEqualTo(600);
    ...
    void whenChangingCartCostRecalculationIsCalled() {
        ...
        cart.addProductToCartByID(2); // 250 +
        cart.addProductToCartByID(3); // 200 +
        cart.addProductToCartByID(3); // 200 = 820
        cart.removeProductByID(1);    // - 170 = 650
    ...
    @Test
    void testSUM() {    // boolean Сломанный-Тест() {
        // Act (Выполнение)
        cart.addProductToCartByID(2); // 250
        cart.addProductToCartByID(2); // 250
    ...
    @DisplayName("dvanced test for calculating TotalPrice")
    @RepeatedTest(10)
